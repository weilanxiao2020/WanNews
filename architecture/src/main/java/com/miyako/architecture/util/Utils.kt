...
class Utils {
    ...
    companion object {
        ...
        private val PERMISSION_ACTIVITY_CLASS_NAME = "com.blankj.utilcode.util.PermissionUtils\$PermissionActivity"
        ...
        fun getApp(): Application {
            return sApplication ?: getApplicationByReflect().also { app ->
                init(app)
            }
        }
        ...
        internal class ActivityLifecycleImpl : Application.ActivityLifecycleCallbacks {
            ...
            private val mDestroyedListenerMap: MutableMap<Activity, MutableSet<OnActivityDestroyedListener>> = HashMap()
